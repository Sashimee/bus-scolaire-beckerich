...
export function AssistantEnfant() {
  ...
  const etapes: Etape[] = [
    ...
    // 4. Le midi. La question ne se pose qu'inscrit au périscolaire : la case est donc
    //    posée ici, en tête de l'écran qu'elle commande, et non deux écrans plus loin.
    {
      cle: 'midi',
      contenu: (
    ...
    // 5. Les heures de présence. Sautée si la case reste décochée : il n'y aurait
    //    rien à y régler.
    ...(periscolaire
      ? [
          {
  ...
  return (
    <>
      ...
      <Assistant
        ...
        // doit suivre, sinon le parent se retrouve devant un écran vide.
